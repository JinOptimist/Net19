        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnergyValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductContain", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductContain_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductContain_ProductId",
                table: "ProductContain",
                column: "ProductId");
