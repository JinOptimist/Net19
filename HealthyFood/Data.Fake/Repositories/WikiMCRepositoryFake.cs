...
namespace Data.Fake.Repositories
{
    public class WikiMCRepositoryFake : BaseRepository<IWikiMCDbModel>, IWikiMCRepository
    {
        public WikiMCRepositoryFake()
        {
            FakeDbModels = new List<IWikiMCDbModel>() {
                new WikiMCDbModel{
                    ...
                    Year = 2023,
                    ImgType = ImgTypeDbModel.proteins},
                new WikiMCDbModel{
                    Id = 2,
        ...
        public IEnumerable<IWikiMCDbModel> GetAllImgByType(ImgTypeDbModel type)
        {
            return FakeDbModels.Where(x => x.ImgType == type);
        }

        public void RemoveAllImgByType(ImgTypeDbModel type)
        {
