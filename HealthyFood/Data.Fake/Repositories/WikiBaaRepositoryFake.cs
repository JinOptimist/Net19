...
{
    public class WikiBaaRepositoryFake : BaseRepository<PageWikiBlock>, IWikiBaaRepository
    {
        public WikiBaaRepositoryFake()
        {
            FakeDbModels =
                new List<PageWikiBlock>(){
        ...
        public void CreateBlock(PageWikiBlock block)
        {
